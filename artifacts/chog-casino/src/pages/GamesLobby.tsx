      ...
      <div className="relative p-6 h-72 flex flex-col justify-between">
        ...
        <div>
          ...
          <div className="flex items-center justify-between mt-3">
            <div>
              <div className="text-xs text-white/40 tracking-widest uppercase mb-0.5">Max Win</div>
              <div className="font-cinzel font-bold text-lg text-neon-gold">{game.multiplier}</div>
            </div>
            <motion.div
