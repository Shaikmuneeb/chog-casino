...
export default function ConnectButton() {
  ...
  if (connected) {
    ...
    return (
      <div
        className="group flex items-center gap-0 px-5 py-2.5 rounded-xl glass border border-purple-400/40 text-purple-100 hover:border-red-400/50 text-sm font-semibold tracking-wide transition-colors"
